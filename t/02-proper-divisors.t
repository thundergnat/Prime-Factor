...
is-deeply(proper-divisors(0), (), 'proper-divisors(0) returns an empty list');
is-deeply(proper-divisors(-8), (), 'proper-divisors of a negative Integer returns an empty list');

is-deeply(proper-divisors('12'), (1, 2, 3, 6, 4), 'proper-divisors of an integer string dispatches ok');

fails-like { proper-divisors('12.5') }, X::AdHoc,
    :message(/'proper-divisors() not defined for Rat parameters. Coerce to Int before calling.'/),
    'non-Integer string fails';

fails-like { proper-divisors('zero') }, X::AdHoc,
    :message(/'proper-divisors() not defined for non Integer strings.'/),
